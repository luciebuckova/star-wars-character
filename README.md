...
This project was inspired by the article [6 suggestions for React.js code test assignments](https://proxify.io/articles/suggestions-for-reactjs-code-test-assignments).
